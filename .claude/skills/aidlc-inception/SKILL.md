...
4. design.md を作る — 構成と技術。要件を満たすのに必要な分だけ書く。見た目が品質の成果物はモックを提示して承認する
5. tasks.md を作る — 1 サイクルで完了できる大きさの単位に割る。id(T1, T2, …)・依存関係・タスクごとの検証(完了条件)を書く。見た目が品質のタスクはユーザーへの提示を検証に含める
